...
species_Oserotype = {"condimenti":["CO1"],
					"dublinensis":["DO1a", "DO1b", "DO2","DO5","DO6","DO7","DO8"],
					"malonaticus":["MaO1", "MaO2", "MaO3", "MaO4","MaO5","MaO6"],
					"muytjensii":["MuO1", "MuO2", "MuO3","MuO4"],
					"sakazakii":["SO1", "SO2", "SO3", "SO4", "SO7","SO8"],
					"turicensis":["TO1", "TO3", "TO4","TO6","TO7","TO8"],
					"universalis":["UO1"]}
